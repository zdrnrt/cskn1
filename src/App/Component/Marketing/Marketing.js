			...
			<div className="container">
				<div className="marketing__content">
					<Title className="subtitle marketing__title" level={2}>
						Антихрупкая машина лидогенерации, <br />в основе которой
						фабрика вертикального видео и собственное реалити-шоу{' '}
						<br />
						«Жизнь в кредит»
					</Title>
...
<rect x="4" y="4" width="48" height="48" rx="24" stroke="#EFF8FF" strokeWidth="8"/>
<path d="M32 22L35 19M35 19L38 22M35 19V25M32 37V35.8C32 34.1198 32 33.2798 31.673 32.638C31.3854 32.0735 30.9265 31.6146 30.362 31.327C29.7202 31 28.8802 31 27.2 31H22.8C21.1198 31 20.2798 31 19.638 31.327C19.0735 31.6146 18.6146 32.0735 18.327 32.638C18 33.2798 18 34.1198 18 35.8V37M28.5 23.5C28.5 25.433 26.933 27 25 27C23.067 27 21.5 25.433 21.5 23.5C21.5 21.567 23.067 20 25 20C26.933 20 28.5 21.567 28.5 23.5Z" stroke="#1570EF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
