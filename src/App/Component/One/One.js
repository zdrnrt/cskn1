...
export default function One() {
	const pluses = plusesList.map((el, i) => (
		<Tile key={i} data={el} type="results" />
	));
	return (
		<motion.div
			initial={{ opacity: 0 }}
		...
		>
			<section className="one section">
				<div className="container">
					<Title level={1} className="one__title">
						AI-powered «Финансовый Терапевт» — первая в мире система
						диагностики и лечения проблем с кредитами и долгами
					</Title>
					<div className="one__content">
							...
							<div className="video">
								<div className="video__content">
									...
									<iframe
										...
										src="https://rutube.ru/play/embed/07e5f61d853ba24fd5cedd136a5ed7e9/"
										frameBorder="0"
						...
						<div className="one__description">
							<Paragraph type="secondary" className="one__text">
								Создаём индустрию антикризисного <br />
								консалтинга для физлиц на рынке объемом
								<br /> 14.5 трлн рублей
							</Paragraph>
