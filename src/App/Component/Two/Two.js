		...
		<section className="two section">
			<div className="container">
				...
				>
					<div className="two__content">
						...
						<Title className="subtitle two__title" level={2}>
							Проблема B2C: <br />
							Запредельно высокая долговая нагрузка
						</Title>
						<div className="two__problems">{problemList}</div>
						<Paragraph className="two__description">
							Долги растут как снежный ком, а существующие игроки
							только усугубляют проблему:
						</Paragraph>
						<ol className="two__list">
							<li className="two__list-item">
								Банки агрессивно продают кредиты
							</li>
							<li className="two__list-item">
								МФО — займы под 300% годовых
							</li>
							<li className="two__list-item">
								Юристы — сразу банкротство
							</li>
						</ol>
					</div>
				</motion.div>
				...
				>
					...
					<Title className="subtitle two__title" level={2}>
						Проблема B2B: <br />
						Поступательное снижение рентабельности
					</Title>
					...
					<Paragraph className="two__description">
						Рост стоимости привлечения клиентов + падение конверсии
						={' '}
						<span className="two__description--marked">
